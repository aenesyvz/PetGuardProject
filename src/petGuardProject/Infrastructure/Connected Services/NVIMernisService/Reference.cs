...
namespace NVIMernisService
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="NVIMernisService.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        System.Threading.Tasks.Task<NVIMernisService.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(NVIMernisService.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public NVIMernisService.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(NVIMernisService.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public NVIMernisService.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(NVIMernisService.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public interface KPSPublicSoapChannel : NVIMernisService.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<NVIMernisService.KPSPublicSoap>, NVIMernisService.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<NVIMernisService.TCKimlikNoDogrulaResponse> NVIMernisService.KPSPublicSoap.TCKimlikNoDogrulaAsync(NVIMernisService.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<NVIMernisService.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            NVIMernisService.TCKimlikNoDogrulaRequest inValue = new NVIMernisService.TCKimlikNoDogrulaRequest();
            inValue.Body = new NVIMernisService.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((NVIMernisService.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
